...
<template>
  <label
    class="flex gap-3 p-4 bg-white dark:bg-gray-900 border-2 rounded-lg cursor-pointer has-[input:checked]:border-primary-500 border-gray-300 dark:border-gray-700 has-[input:focus]:ring-1 ring-primary-200 has-[input:disabled]:opacity-60 [&_*]:select-none [&_*]:cursor-pointer"
  >
    <URadio
      class="mt-0.5"
      :name="name"
    ...
    <div class="flex-1 flex flex-col">
      <div class="flex gap-2 mb-1 -mt-px">
        ...
        <span class="font-medium txt-secondary">
          {{ label }}
        </span>
        <div
      ...
      <span class="text-sm txt-tertiary whitespace-pre-line">
        {{ help }}
      </span>
      <div
